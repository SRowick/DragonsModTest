...
function Client_PresentConfigureUI(rootParent)
	...
	UI.CreateLabel(row1).SetText('How much gold it costs to buy a dragon');
	...
	UI.CreateLabel(row2).SetText('How powerful the dragon is (in armies)');
	...
	UI.CreateLabel(row3).SetText('How many dragons each player can have at a time');
