...
function PurchaseClicked()
	...
	if (numTanksAlreadyHave >= Mod.Settings.MaxTanks) then
		UI.Alert("You already have " .. numTanksAlreadyHave .. " dragons, and you can only have " ..  Mod.Settings.MaxTanks);
		return;
	end
...
function SelectTerritoryClicked()
	...
	TargetTerritoryInstructionLabel.SetText("Please click on the territory you wish to receive the dragon on.  If needed, you can move this dialog out of the way.");
...
function CompletePurchaseClicked()
	local msg = 'Buy a dragon egg on ' .. SelectedTerritory.Name;
